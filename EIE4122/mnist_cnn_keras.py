...
if __name__ == '__main__':
    ...
    if args.mode == 'train':
        ...
        tbCallBack = TensorBoard(log_dir='./log', # the path of the directory where to save the log files to be parsed by TensorBoard
                        ...
                        write_grads=True,         # whether to visualize the histogram of gradient values in TensorBoard
