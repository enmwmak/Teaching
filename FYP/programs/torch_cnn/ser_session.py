...
two speakers) as test data. For illustration purpose, a simple 1D-CNN on MFCC features was used.
...
if __name__ == "__main__":
    ...
    # Perform leave-one-session(spk)-out cross-validation
    results = []
    sess_list = np.arange(1,6)
    for k in range(1,6):
        ...
        print(f"Training speaker ID: {train_set.sess_ids}");
        print(f"Test speaker ID: {test_set.sess_ids}");
